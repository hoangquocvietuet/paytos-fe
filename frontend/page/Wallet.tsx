...
export const WalletPage = () => {
  return (
    <main className="max-w-screen-xl mx-auto flex flex-col items-center gap-10">
      <h1 className="mx-auto text-4xl bg-black inline-block py-1 px-10 rounded-full bg-gradient mt-10">Main Wallet</h1>
      ...
      <h2 className="mx-auto text-4xl bg-black inline-block py-1 px-10 rounded-full bg-gradient">Stealth Wallets</h2>
        ...
        {wallets.map((wallet, index) => (
          <div key={index} className="flex items-center gap-4 w-full mx-auto font-['Prototype']">
            ...
            <div className="flex justify-between border p-4 w-full border-gradient text-3xl">
              ...
              <p className="text-[#F8C265]">{wallet.balance} USDC</p>
            </div>
          </div>
        ))}
      </div>
